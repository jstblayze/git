...
public class LootManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        GameManager.CharacterSelected = Enums.Character.Ryley; // NEED TO DELETE THIS LATER
    ...
    public void ResetInventoryScreen()
    {
        ...
        foreach (Transform Child in (ZoneManager.LootableInventoryScreen.GetComponentInChildren<Transform>()))
        {
